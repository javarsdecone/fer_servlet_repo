	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(expenses.isEmpty()) {
			...
			for(Expense expense : expenses) {
				...
				String desc = expense.getType()+", "+expense.getDate()+", "+expense.getTotal()+", "+expense.getBywhom();
				out.println("	<option value='"+value+"'>"+desc+"</option>");
			}
			
			out.println("</select>");
			
			out.println("<input type = 'button' value = 'Next' onClick=\"javascript: submitForm('displayEditExpense')\">");
